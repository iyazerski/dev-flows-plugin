...
3. Use `collect-context` to create the task context packet from the PR description, linked task/docs, base/head refs, changed files, diff summary, temporary worktree path, and loop artefact path.
4. Use `review-changes` to review the PR diff against the task context packet.
